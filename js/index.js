	...
	<form className="form-signin" style={{borderRadius:"14px"}}>
	  ...
	  <div className="control-group" id="account_group">
		<div className="controls">
		  ...
		  <span style={{marginTop: "5px"}} className="help-inline" style={{display: "none"}} id="account_warning">帳號不存在</span>
		</div>
	  </div>
  ...
  render(){
	return (
	  <div style={{margin:"0px auto"}}>
		<img src={this.urls["Pulse"]} style={{display:"block", margin:"auto"}} />
	  </div>
	)
  }
...
class Main_Login extends React.Component {
...
<!--style.css-->
<link href="//drive.google.com/uc?id=1x5TnbSM6F2GqyfsQlMEjmJW5Ftk9RmBB&export=download" rel="stylesheet" media="screen">
<!--Front_end/assets/DT_bootstrap.css-->
<link href="//drive.google.com/uc?id=1gdeClxfhh8-Cetgr6DkJswP_9_R1v78j&export=download" rel="stylesheet" media="screen">
<!--datapicker.css-->
<link href="//drive.google.com/uc?id=1stP8rcGfGzwyu33M0OK049eD_Kjw3-pS&export=download" rel="stylesheet" media="screen">
<!--uniform.default.min.css-->
<link href="//drive.google.com/uc?id=1HGKy0uZGP9SKOzHVVgLeN--DB8ukoOun&export=download" rel="stylesheet" media="screen">
<!--chosen.min.css-->
<link href="//drive.google.com/uc?id=1T10XZ2oN8iWxxn-Db4zlNt6v4xDEOz4_&export=download" rel="stylesheet" media="screen">
<!--core-->
...
<script src="//drive.google.com/uc?id=1U0Lz7TYkyM3wZUuffNUMweu8pOZsTnYv&export=download" async></script>
<script src="//drive.google.com/uc?id=1z72zPtIu_EX6Bfq5i5RSr53uhgrBJwCF&export=download" async></script>
<!--bootstrap.min.js-->
<script src="https://cdnjs.cloudflare.com/ajax/libs/twitter-bootstrap/4.6.0/js/bootstrap.min.js" integrity="sha512-XKa9Hemdy1Ui3KSGgJdgMyYlUg1gM+QhL6cnlyTe2qzMCYm4nAZ1PsVerQzTTXzonUR+dmswHqgJPuwCq1MaAg==" crossorigin="anonymous" async></script>
<script src="//drive.google.com/uc?id=1QrJDYI6O6FJVw44hmTJdcLdU3IN5Vj3E&export=download" async></script>
<!--jquery-ui 原版為1.10.3-->
<script src="https://ajax.googleapis.com/ajax/libs/jqueryui/1.12.1/jquery-ui.min.js" async></script>
<!--jquery.easy-pie-chart.js-->
<script src="//drive.google.com/uc?id=1TF87wUXakKSai5tcjZjw37OMRoDojIKG&export=download" async></script>
<!--scripts.js-->
<script src="//drive.google.com/uc?id=1NNuggUWnF0GzolbdosmfxbQ0sRvaHiC7&export=download" async></script>
<!--datatable-->
<script src="//drive.google.com/uc?id=1m7QZ-VHMaS1aLPCU0g1H9A2dQ6Kvddjf&export=download" async></script>
<!--Front_end/assets/DT_bootstrap.js-->
<script src="//drive.google.com/uc?id=173UcfAtAJ80bwB-O2la2yRszV9WNATN9&export=download" async></script>    
<script src="//drive.google.com/uc?id=1VchYIwf5gXb7zNgmpT8AmvbfeSUvL_q-&export=download" async></script>    
<!--main.min.js, fullCalendar 4.2.0-->
<!--core-->
<script src="https://cdnjs.cloudflare.com/ajax/libs/fullcalendar/4.2.0/core/main.min.js" integrity="sha512-bg9ZLPorHGcaLHI2lZEusTDKo0vHdaPOjVOONi4XLJ2N/c1Jn2RVI9qli4sNAziZImX42ecwywzIZiZEzZhokQ==" crossorigin="anonymous" async></script>
<script src="https://cdnjs.cloudflare.com/ajax/libs/fullcalendar/4.2.0/core/locales-all.min.js" integrity="sha512-VsrFSGgqerN0+6shpMgjAs+YVNWb9OWO5mi+Z9Itwe0Di12J/yiK15RzocX4iI3eRuu7RUDXz/I5iQ6D8DMd9w==" crossorigin="anonymous" async></script>
<script src="https://cdnjs.cloudflare.com/ajax/libs/fullcalendar/4.2.0/daygrid/main.min.js" integrity="sha512-kebSy5Iu+ouq4/swjgEKwa217P2jf/hNYtFEHw7dT+8iLhOKB5PG5xaAMaVyxRK7OT/ddoGCFrg8tslo8SIMmg==" crossorigin="anonymous" async></script>
<script src="https://cdnjs.cloudflare.com/ajax/libs/fullcalendar/4.2.0/timegrid/main.min.js" integrity="sha512-APuj9Rm7J37dj8cRB1qwznH+zrWD7/vkaodDwJVxpdk72m5c9u8mbbdLHn6JnSw5M4AhV8Zb1HnLrNMGoOfR/g==" crossorigin="anonymous" async></script>
<script src="https://cdnjs.cloudflare.com/ajax/libs/fullcalendar/4.2.0/interaction/main.min.js" integrity="sha512-9M3YQ9E3hEtjRZSQdU1QADaOGxI+JAzq6bieArw7nIxQbPmn10M7TYxhvJZCuvSjlncJG24l+/e5d1bTRN3m4g==" crossorigin="anonymous" async></script>
<script src="https://cdnjs.cloudflare.com/ajax/libs/fullcalendar/4.2.0/bootstrap/main.min.js" integrity="sha512-uuua5cS/LUZHEtZiY2s+SRn0h46TbLZjcaf7fztYqdzM+a0t81kw05yLZSjwF3l3lonm53GZ45rSSzAWAwA5Sg==" crossorigin="anonymous" async></script>
<script src="https://cdnjs.cloudflare.com/ajax/libs/fullcalendar/4.2.0/list/main.min.js" integrity="sha512-Iw4G4+WD3E3F0M+wVZ95nlnifX1xk2JToaD4+AB537HmOImFi79BTtWma57mJeEnK2qNTOgZrYLtAHVsNazzqg==" crossorigin="anonymous" async></script>
